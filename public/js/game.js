...
var Game = function (_Phaser$Game) {
  ...
  function Game() {
    ...
    var _this = _possibleConstructorReturn(this, (Game.__proto__ || Object.getPrototypeOf(Game)).call(this, window.innerWidth, window.innerHeight, Phaser.CANVAS, 'game', null));
...
var _class = function (_Phaser$State) {
  ...
  _createClass(_class, [{
    ...
    value: function create() {
      ...
      var gameHeader = game.add.text(this.game.world.centerX, this.game.world.centerY - 100, 'Floppy Flute', { align: "center", font: "100px Arial", fill: '#ffffff' });
      gameHeader.anchor.setTo(0.5, 0.5);
      var style = { align: "center", font: "50px Arial", fill: '#ffffff' };
      var menu = [];
      var menuItem1 = game.add.text(this.game.world.centerX, this.game.world.centerY + 50, 'Play', style);
      var menuItem2 = game.add.text(this.game.world.centerX, this.game.world.centerY + 150, 'Options', style);
...
var _class = function (_Phaser$State) {
  ...
  _createClass(_class, [{
    ...
    value: function addRowOfPipes() {
      ...
      for (var i = 0; i < 8; i++) {
        if (i != hole && i != hole + 1) this.addOnePipe(window.innerWidth, i * 120 + 10);
      }
    }
  }, {
    key: 'hitPipe',
